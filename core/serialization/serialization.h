...
#define TYPE_TREE_ADD(ENTRY, TYPE_INFO_STRUCT) type_tree.push_back(TypeEntry(((char *)&ENTRY) - root, &( TYPE_INFO_STRUCT :: instance)))
#define TYPE_TREE_STRUCT(STRUCT, TYPE_INFO_STRUCT) type_tree.push_back(TypeEntry(0, &( TYPE_INFO_STRUCT :: instance ), true))
...
#define FUNDAMENTAL_TYPE(TYPENAME)\
    ...
    // TYPE_ ## TYPENAME TYPE_INFO<TYPE_ ## TYPENAME> :: instance;\
