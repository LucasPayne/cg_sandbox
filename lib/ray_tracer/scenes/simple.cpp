...
#if 1
{
    ...
    primitives.push_back(new GeometricPrimitive(
                         ...
                         bunny),
                         // new ImageTextureRGB("images/ice.bmp", false, new CylinderMapper()),
                         new CheckerTexture(32,4,
                             new ConstantTextureRGB(0.1,0.1,0.1),
                             new ConstantTextureRGB(0.9,0.9,0.9),
                             new CylinderMapper()),
                         NULL,
                         0.3
                         ));
...
{
    Model *dragon = load_OFF_model("models/dragon.off", 3.8, Point(0,1,0), true, true);
    primitives.push_back(new GeometricPrimitive(
                         new TriangleMesh(Transform::translate(-3.5,1.2,6) * Transform::y_rotation(0.5),
                         dragon),
                         new ImageTextureRGB("images/ice.bmp", false, new CylinderMapper()),
                         NULL,
                         0.3
...
#if 0
{
    ...
    primitives.push_back(new GeometricPrimitive(
                         ...
                         new ImageTextureRGB("images/marble_tile.bmp", false, new CylinderMapper()),
                         NULL, 0, 1.5
                         ));
    }
}
    ...
    scene->add_light(new PointLight(Point(4,8,4), 10.f*RGB(0.68,0.688,1)));
